...
////           vistaCliente.setVisible(true);
        Usuario supervisorSimulado = new Usuario();
        supervisorSimulado.setNombre("David");
        supervisorSimulado.setRol("Supervisor");

        // 2. Instanciamos la vista total
        
        VistaPrincipalSupervisor vistaTotal = new VistaPrincipalSupervisor("","");

        // 3. Pasamos la vista al controlador para que amarre los hilos
        ControladorInventarioSupervisor controlador = new ControladorInventarioSupervisor(vistaTotal, supervisorSimulado);

        // 4. Encendemos la interfaz
        vistaTotal.setVisible(true);
