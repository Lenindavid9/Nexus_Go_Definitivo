...
public class ControladorModificarCitas {
    ...
    /**
     * Correo enviado al cliente cuando el peluquero RECHAZA su cita
     * pendiente (parte del "else" de notificación del requerimiento #5).
     */
    private boolean enviarCorreoRechazo(String destinatario, String servicio, String fechaHora) {
        ...
        try {
            ...
            String cuerpoTexto = "¡Hola! 👋\n\n"
                    + "Lamentamos informarte que tu solicitud de cita no pudo ser aceptada por el especialista.\n\n"
                    + "📍 === DETALLES DE LA SOLICITUD ===\n"
                    + "🛠️ Servicio: " + servicio + "\n"
                    + "📅 Fecha y Hora solicitada: " + fechaHora + "\n\n"
                    + "💡 Te invitamos a agendar una nueva cita en otro horario disponible.\n\n"
                    + "Atentamente,\nEl equipo de NexusGO 🚀";
            ...
            System.err.println("❌ Error crítico al enviar el correo de rechazo a " + destinatario + ": " + e.getMessage());
            return false;
        }
    }
