 ...
 * @author USUARIO
 */
public class VistaAgregarPromocionProducto extends JPanel{
    ...
    public VistaAgregarPromocionProducto() {
        ...
        JLabel lblTitulo = new JLabel("Registrar promocion producto");
        ...
        // 1. CAMPO: Nombre del producto (JComboBox con productos de BD)
        gbc.gridx = 0;
        gbc.gridy++;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.WEST;
        panelTarjeta.add(crearEtiqueta("Nombre del producto"), gbc);

        gbc.gridy++;
        comboProductos = new JComboBox<>();
        comboProductos.setFont(new Font("SansSerif", Font.PLAIN, 13));
        comboProductos.setBackground(Color.WHITE);
        comboProductos.setPreferredSize(new Dimension(380, 38));
        comboProductos.setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200), 1));
        panelTarjeta.add(comboProductos, gbc);
        ...
        btnCargarImagen = new JButton("Imagen del producto");
        ...
        lblNombreImagen = new JLabel("imagenproducto.png");
