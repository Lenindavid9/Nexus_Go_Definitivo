...
public class CajaDao {
    ...
    /**
     * Abre una nueva caja para el operador indicado.
     * Devuelve el id_caja generado, o 0 si falla.
     */
    public int guardarApertura(double montoApertura, int idOperador) {
        String sql = "INSERT INTO cajas (id_operador, fecha_apertura, monto_apertura, estado_caja) "
                   + "VALUES (?, NOW(), ?, 'ABIERTA')";
        try (Connection con = cn.getConection();
    ...
    /**
     * Devuelve el id_caja de la caja actualmente ABIERTA (la más reciente), o 0 si no hay ninguna.
     */
